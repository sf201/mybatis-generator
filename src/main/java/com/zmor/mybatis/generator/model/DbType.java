...
public enum DbType {
    ...
    MySQL("com.mysql.jdbc.Driver", "jdbc:mysql://%s:%s/%s?useUnicode=true&useSSL=false&verifyServerCertificate=false&characterEncoding=%s", "mysql-connector-java-5.1.38.jar"),
